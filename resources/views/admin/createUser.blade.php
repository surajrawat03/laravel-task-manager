<x-app-layout>
  <div class="flex p-6 items-center justify-center min-h-screen bg-gray-100">
      <form method="POST" action="{{ route('store-user') }}" class="w-full max-w-lg sm:max-w-xl lg:max-w-3xl bg-white p-6 sm:p-8 rounded-lg shadow-md">
          @csrf
        ...
        <input type="hidden" name="validatePassword" value="true">
